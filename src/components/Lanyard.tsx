...
import lanyard from '../assets/lanyard/lanyard-sg.png';
import './Lanyard.css';
...
export default function Lanyard({
  ...
  return (
    <div className={['lanyard-wrapper', className].filter(Boolean).join(' ')} data-lenis-prevent>
      <Canvas
        camera={{ position, fov }}
    ...
    <>
      <group position={[0, 4, 0]}>
        ...
        <RigidBody position={[2, 0, 0]} ref={card} {...segmentProps} type={dragged ? 'kinematicPosition' : 'dynamic'}>
          <CuboidCollider args={[1.05, 1.48, 0.01]} />
          <group
            scale={2.95}
            position={[0, -1.2, -0.05]}
