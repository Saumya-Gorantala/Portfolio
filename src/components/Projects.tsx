  ...
  const projects: Project[] = [
    {
      ...
      image: `${import.meta.env.BASE_URL}assets/property-management.jpg`,
      links: [
    ...
    },
    {
      ...
      image: `${import.meta.env.BASE_URL}assets/job-tracker.jpg`,
      links: [
    ...
    },
    {
      ...
      image: `${import.meta.env.BASE_URL}assets/lingo-quest.jpg`,
      links: [
    ...
    },
    {
      ...
      image: `${import.meta.env.BASE_URL}assets/apt-ease.png`,
      links: [
        { label: "View on Behance", url: "https://www.behance.net/saumyagorantala6", icon: "external" },
    ...
    },
    {
      ...
      link: "https://www.behance.net/saumyagorantala6",
      image: `${import.meta.env.BASE_URL}assets/bakle.png`,
      links: [
        { label: "View on Behance", url: "https://www.behance.net/saumyagorantala6", icon: "external" },
