...
// Defined outside the component so the array reference is stable across re-renders,
// preventing CircularGallery from resetting its scroll state when the modal opens/closes.
